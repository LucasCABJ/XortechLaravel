                            ...
                            <div class="card-body p-5">
                                ...
                                <div class="row">
                                    <div class="col-lg-5 d-lg-block d-flex justify-content-center align-items-center">
                                        <form action="{{ route('user.update_profile_pic') }}" class="d-none p-3"
                                        ...
                                        <div class="rounded position-relative profilepic-container"
                                            ...
                                            <img src="@if (Auth::user()->image == '' || !Storage::disk('local')->has('public/images/usup/' . Auth::user()->image)) {{ asset('assets/img/default-male.png') }}@else{{ asset('storage/images/usup/' . Auth::user()->image) }} @endif"
                                    ...
                                    <div class="col-lg-7 pt-3">
                                        <h1 class="text-th-secondary">{{ Auth::user()->name }} <span
                                                class="h6 text-th-grey">({{ Auth::user()->email }})</span></h1>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                ...
                                                <input id="name" type="text"
                                                    class="form-control @error('name') is-invalid @enderror fs-4"
                                                    name="name"
